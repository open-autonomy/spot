...
|| `"LastMileId"` | LastMileID | UUID | The UUID identifying the sequence of messages related to the same last mile from request to last message reporting leaving place or quitting last mile |
